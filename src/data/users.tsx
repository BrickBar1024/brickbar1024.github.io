...
const Users: User[] = [
  ...
  {
    title: 'CDDFuse',
    description: 'CVPR2023|结合Transformer和CNN的多任务多模态图像融合方法',
  ...
  {
    title: 'ChatGPT润色',
    description: 'ChatGPT能否替代人工润色,终结高成本润色时代?',
  ...
  {
    title: 'CVPR23最新125篇论文分方向整理',
    description: '检测,分割,人脸,视频处理,医学影像,神经网络结构,小样本学习等方向',
  ...
  {
    title: 'Softmax函数和它的误解',
    description: 'Softmax是一个数学函数,用于对0和1之间的值进行归一化...',
  ...
  {
    title: '交叉熵损失和平方损失究竟有何区别?',
    description: '交叉熵损失(Cross-entropy)为什么会优于平方损失(MSE),本文详细讲解了两者之间的差别以及两者的优缺点',
  ...
  {
    title: 'DeepMIM​',
    description: '微软亚研院最新工作,DeepMIM旨在网络的浅层加入额外的监督,使得浅层特征的学习更有意义',
  ...
  {
    title: 'CVPR2023|有趣的动态3D场景重建​',
    description: 'CVPR2023|港科大&腾讯AI Lab&港大联合出品:有趣的动态3D场景重建',
  ...
  },
  {
    ...
    description: 'CVPR2023即插即用系列|BiFormer:基于动态稀疏注意力构建高效金字塔网络架构',
  ...
  {
    title: 'CVPR2023|RODIN',
    description: '近日,由微软亚研院提出的Roll-out Diffusion Network(RODIN)模型,首次实现了利用生成扩散模型在3D训练数据上自动生成3D数字化身(Avatar)的功能',
  ...
  {
    title: '没想到Dropou还藏了一手!',
    description: '不仅可以防止过拟合,也可以减小欠拟合?来自FAIR,Meta AI,UC Berkeley,MBZUAI的研究员们继续对Dropout进行了探索,证明了在训练开始时使用Dropout也可以缓解欠拟合。',
  ...
  {
    title: 'CVPR2023论文分类汇总',
    description: '一个专为计算机视觉领域研究者打造的学术资源宝库,CVPR2023作为计算机视觉领域的顶级会议之一,每年都吸引了众多学者们的关注',
    preview: require('./showcase/CVPR2023Classification.png'),
    website: 'https://mp.weixin.qq.com/s/g8yUdF0SP-81VpVfFjTqNw',
    source: 'https://github.com/52CV/CVPR-2023-Papers',
    tags: ['AI','CVPR'],
  },
  {
    title: '用GPT-4搞科研,细到每个工作流程',
    description: 'LeCun力荐!哈佛博士分享用GPT-4搞科研,细到每个工作流程',
    preview: require('./showcase/GPT4Academic.png'),
    website: 'https://mp.weixin.qq.com/s/eHFxPhTHbymDSSloYyR1Vw',
    source: 'https://mp.weixin.qq.com/s/eHFxPhTHbymDSSloYyR1Vw',
    tags: ['AI','GPT4'],
  },
  {
    title: 'FastViT',
    description: '即插即用！Apple新作FastViT: 又快又强的视觉Transformer,端侧部署无压力',
    preview: require('./showcase/FastViT.png'),
    website: 'https://mp.weixin.qq.com/s/v02SJZrhUaortZBLp1AI8w',
    source: 'https://arxiv.org/abs/2303.14189',
    tags: ['AI','Transformer'],
  },
  {
    title: '同济子豪兄精读AI经典论文笔记',
    description: 'B站20万粉丝宝藏UP主“同济子豪兄”把人工智能和计算机视觉领域最高引用,最有影响力,每一个硕博生都必读的20余篇论文做了详细的笔记批注和论文逐句精读视频',
    preview: require('./showcase/ZihaoPaper.png'),
    website: 'https://mp.weixin.qq.com/s/5xMFyqCD_OBFWBmR6OwwaQ',
    source: 'https://github.com/TommyZihao/zihao_course/tree/main/Paper',
    tags: ['AI'],
  },
  {
    title: 'GPU利用率低常见原因分析及优化',
    description: 'GPU利用率低,GPU资源严重浪费?本文和大家分享一下解决方案,希望能对使用GPU的同学有些帮助',
    preview: require('./showcase/ZihaoPaper.png'),
    website: 'https://mp.weixin.qq.com/s/O0-2O7EbgYVVRWyKvT3WSA',
    source: 'https://mp.weixin.qq.com/s/O0-2O7EbgYVVRWyKvT3WSA',
    tags: ['AI','Tips'],
  },
  {
    title: '20种卷积',
    description: '本文将从背景,原理,特性及改进四个维度分别梳理10篇影响力深远的经典卷积模块以及10篇具有代表性的卷积变体,使读者对卷积的发展脉络有一个更加清晰的认知',
    preview: require('./showcase/Convolution.png'),
    website: 'https://mp.weixin.qq.com/s/4M-rAJtYh2igftEyTkZznA',
    source: 'https://mp.weixin.qq.com/s/4M-rAJtYh2igftEyTkZznA',
    tags: ['AI'],
  },
  {
    title: 'LMFlow',
    description: '3090单卡5小时,每个人都能训练专属ChatGPT,港科大开源LMFlow',
    preview: require('./showcase/LMFlow.png'),
    website: 'https://mp.weixin.qq.com/s/LCGQyNA6sHcdfIIARSNlww',
    source: 'https://github.com/OptimalScale/LMFlow',
    tags: ['AI','ChatGPT'],
  },
  {
    title: 'HuggingGPT',
    description: 'ChatGPT自己会选模型了!微软亚研院+浙大爆火新论文,HuggingGPT项目已开源',
    preview: require('./showcase/HuggingGPT.png'),
    website: 'https://mp.weixin.qq.com/s/iVlc_MKSB7LFtGT-9K2hcA',
    source: 'https://arxiv.org/pdf/2303.17580.pdf',
    tags: ['AI','ChatGPT'],
  },
  {
    title: 'PyTorch下的可视化工具',
    description: 'PyTorch下的可视化工具(网络结构/训练过程可视化)',
    preview: require('./showcase/Visualization.png'),
    website: 'https://mp.weixin.qq.com/s/sIcZX2NgKmMEWyjxTBP-Lw',
    source: 'https://mp.weixin.qq.com/s/sIcZX2NgKmMEWyjxTBP-Lw',
    tags: ['AI'],
  },
  {
    title: 'MicroNet',
    description: '吊打MobileNetV3!MicroNet通过极低FLOPs实现图像识别',
    preview: require('./showcase/Visualization.png'),
    website: 'https://mp.weixin.qq.com/s/I-CWqVP0Pl0woGUwLBS0uQ',
    source: 'https://doi.org/10.48550/arXiv.2011.12289',
    tags: ['AI'],
  },
